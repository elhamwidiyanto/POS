                            ...
                            <div class="card-body">
                                <form @submit.prevent="handleSearch">
                                    <div class="input-group mb-3">
                                        ...
                                        <Link href="/apps/roles/create" class="btn btn-primary input-group-text"> <i class="fa fa-plus-circle me-2"></i> NEW</Link>
                                    ...
                                    <tbody>
                                        <tr v-for="(role, index) in roles.data" :key="index">
                                            ...
                                            <td class="text-center">
                                                <Link :href="`/apps/roles/${role.id}/edit`" class="btn btn-success btn-sm me-2"><i class="fa fa-pencil-alt me-1"></i> EDIT</Link>
                                                <button @click.prevent="destroy(role.id)" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> DELETE</button>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
